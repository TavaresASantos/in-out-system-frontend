    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 relative overflow-hidden px-4">
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-3xl shadow-xl border border-gray-100 relative z-10">
        <div className="flex flex-col items-center">
          <div className="w-24 h-24 relative mb-4 p-2 bg-brand-veryLightGreen rounded-full flex items-center justify-center">
            <img 
          ...
          <h2 className="text-2xl font-black text-brand-darkGreen tracking-tight text-center">
            In-Out System
          </h2>
          <p className="text-gray-500 text-sm font-medium mt-1">
            Portal Administrativo - Parque da Matinha
          </p>
        </div>
